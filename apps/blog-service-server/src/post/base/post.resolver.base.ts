...
export class PostResolverBase {
  ...
  @graphql.ResolveField(() => Blog, {
    nullable: true,
    name: "blog",
  })
  async getBlog(@graphql.Parent() parent: Post): Promise<Blog | null> {
    const result = await this.service.getBlog(parent.id);
